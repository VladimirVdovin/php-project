...
if (!empty($_POST)) {
	...
	if (is_string($name) && is_numeric($age) && is_numeric($salary)) {
...
// Выводим сообщение, что форма сохранена
...
<body style="text-align: center;">
	...
	<main>
		...
		<div style="background-color: Gainsboro; text-align: center;">
			...
			Нажмите на кнопку. Это ссылка на result.php
			<br>
