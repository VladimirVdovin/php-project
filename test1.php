...
закомментировал -->
    ...
    после перезагрузки страницы");
        ...
        if (!isset($_COOKIE['start_moment']) && empty($_COOKIE['time_diff'])) {
            $startMoment = time();
            setcookie('start_moment', $startMoment);
            setcookie('time_diff', $startMoment);
        }
        ...
        if (!isset($_COOKIE['cookie_for_delete'])) {
            $cookieForDelete = 'Кука еще есть, но после обновления 
        ...
        if (!isset($_COOKIE['cookie_for_delete2']))
            ...
            $cookieForDelete2 = 'Если этот текст не повторяется два раза,<br>
            значит кука была моментально удалена и текст остался только в переменной';
        setcookie('cookie_for_delete2', $cookieForDelete2, time() + 1000);
        setcookie('cookie_for_delete2', $cookieForDelete2, time());
        ...
        <div style="text-align: center;">
            ...
            <div style="background-color: Gainsboro; text-align: center;">
                ...
                <?php if (isset($_SESSION['user']) && isset($_GET['user'])) : ?>
            ...
            <div style="text-align:center" ;>
                ...
                <?php
                if (!empty($_GET) && isset($_SESSION['name1'])) : ?>
                ...
                <div style="background-color: Gainsboro; text-align: center;">
                    ...
                    if (!isset($_COOKIE['start_moment']) && empty($_COOKIE['time_diff'])) {
                        ...
                        $currentMoment = time();
                        $_COOKIE['time_diff'] = $currentMoment - $_COOKIE['start_moment'];
                ...
                <div style="background-color: Gainsboro; text-align: center;">
                    ...
                    <?php
                    if (!empty($cookieForDelete)) {
                        echo $cookieForDelete;
                    }
                    ?>
